package com.peng.plant.deangjun.utils;
...
public class ScrollZoomLayoutManager extends RecyclerView.LayoutManager {
    private static final float SCALE_RATE = 1.3f; //1.2  //1.5f
...
//        Log.d("asdasdasd", "getCurrentPosition: "+ Math.round(offsetScroll/(float)offsetDistance));
        Log.d("sdsad", "getCurrentPosition: 현재의 포지션값"+ Math.round(offsetScroll/(float)offsetDistance));
